...
const ProductsPage = () => {
  ...
  const ProductCard = ({ product, updateCartCount, flyToCart }) => {
    ...
    return (
      <Link to={`/patientdashboard/product/${product.id}`} className="group">
        ...
        <header className="sticky top-0 z-50 bg-gray-50">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <Link to="/patientdashboard/orders" className="text-gray-700 hover:text-[var(--primary-color)] font-medium">Orders</Link>
              <Link to="/patientdashboard/cartproduct" ref={cartRef} className="relative p-2 text-gray-700 hover:text-[var(--primary-color)]">
