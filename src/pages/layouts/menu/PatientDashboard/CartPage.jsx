...
const CartPage = () => {
  ...
  return (
    <div className="p-6 bg-white mt-6 rounded-2xl shadow-lg">
      <button onClick={() => navigate('/patientdashboard/lab-tests')} className="flex items-center text-sm text-[var(--primary-color)] mb-6 hover:underline">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md space-y-6">
          ...
          <button className="btn btn-primary w-full"
            onClick={() => navigate(`/patientdashboard/available-labs/${cart[0]?.id}`, { state: { test: cart[0] } })}>Proceed to Book</button>
