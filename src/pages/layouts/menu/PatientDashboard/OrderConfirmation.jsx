    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/patientpatientdashboard/shopping" className="text-[var(--primary-color)] hover:text-[var(--accent-color)]">
            Return to Shop
          </Link>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <div className="text-sm text-gray-700 space-y-1">
              ...
              <Link to={`/patientdashboard/track-order/${localOrder.id}`} state={{ order: localOrder }} className="text-[var(--accent-color)] hover:underline">
                Track Order
              </Link>
            </div>
          </div>
